...
#c.Authenticator.admin_users = ["ibobkov,itkachenko"]
#c.ConfigurableHTTPProxy.auth_token = "111"
...
c.LDAPAuthenticator.server_address = 'ldap://homecredit.ru'
c.LDAPAuthenticator.server_port = 389
c.LDAPAuthenticator.lookup_dn = True
c.LDAPAuthenticator.lookup_dn_search_filter = '({login_attr}={login})'
c.LDAPAuthenticator.lookup_dn_search_user = 'CN=hadoop int,OU=Technicals Accounts,OU=All Users,DC=homecredit,DC=ru'
c.LDAPAuthenticator.lookup_dn_search_password = 'YGMZGnbBf=-7B|~jfCqh'
c.LDAPAuthenticator.base_dn = 'dc=homecredit,dc=ru'
c.LDAPAuthenticator.bind_dn_template = ['{username}',]
c.LDAPAuthenticator.user_search_base = 'dc=homecredit,dc=ru'
c.LDAPAuthenticator.user_attribute = 'sAMAccountName'
...
c.LDAPAuthenticator.allowed_groups = ['CN=Список рассылки SmartData Users,OU=Группы рассылок,OU=Группы,DC=homecredit,DC=ru']
...
#  
#jupyterhub &>> /var/log/jupyterhub/jupyterhub.log
#run(['jupyterhub', '&>>', '/var/log/jupyterhub/jupyterhub.log'])
#check_call(jupyterhub &>> /var/log/jupyterhub/jupyterhub.log)
#  Default: ''
